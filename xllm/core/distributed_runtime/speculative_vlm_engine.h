...
class SpeculativeVLMEngine : public Engine {
 public:
  explicit SpeculativeVLMEngine(const runtime::Options& options);

  virtual ~SpeculativeVLMEngine() = default;
 ...
 private:
  ...
  std::unique_ptr<VLMEngine> engine_;
