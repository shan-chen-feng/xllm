...
inline size_t get_dit_forward_input_size(const DiTForwardInput& input) {
  ...
  // Vector of strings
  size += get_vector_size(input.prompts);
  size += get_vector_size(input.prompts_2);
  size += get_vector_size(input.negative_prompts);
  size += get_vector_size(input.negative_prompts_2);
...
inline void write_dit_forward_input(char*& buffer,
  ...
  write_vector(buffer, input.prompts);
  write_vector(buffer, input.prompts_2);
  write_vector(buffer, input.negative_prompts);
  write_vector(buffer, input.negative_prompts_2);
...
inline void read_dit_forward_input(const char*& buffer,
  ...
  read_vector(buffer, input.prompts);
  read_vector(buffer, input.prompts_2);
  read_vector(buffer, input.negative_prompts);
  read_vector(buffer, input.negative_prompts_2);
