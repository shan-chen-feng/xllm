...
static std::vector<std::pair<int, std::string>> WEIGHT_MAPPING = {
    ...
    {AUDIO_IN_WATTENTION_OUT_WEIGHT, "attn.proj.weight"},
    {AUDIO_IN_WATTENTION_OUT_BIAS, "attn.proj.bias"},
...
void NpuQwen3AudioEncoderLayerImpl::get_weights_col_packed_qkv() {
  ...
  */
  ...
  at_weight_tensors_[AUDIO_IN_Q_WEIGHT] =
      (at_weight_tensors_[AUDIO_IN_Q_WEIGHT].chunk(worldSize, 0))[rank];
  at_weight_tensors_[AUDIO_IN_K_WEIGHT] =
      (at_weight_tensors_[AUDIO_IN_K_WEIGHT].chunk(worldSize, 0))[rank];
  at_weight_tensors_[AUDIO_IN_V_WEIGHT] =
      (at_weight_tensors_[AUDIO_IN_V_WEIGHT].chunk(worldSize, 0))[rank];
  // bias
  at_weight_tensors_[AUDIO_IN_Q_BIAS] =
      (at_weight_tensors_[AUDIO_IN_Q_BIAS].chunk(worldSize, 0))[rank];
  at_weight_tensors_[AUDIO_IN_K_BIAS] =
      (at_weight_tensors_[AUDIO_IN_K_BIAS].chunk(worldSize, 0))[rank];
  at_weight_tensors_[AUDIO_IN_V_BIAS] =
      (at_weight_tensors_[AUDIO_IN_V_BIAS].chunk(worldSize, 0))[rank];
}
