...
using BatchFeatureValue = std::variant<torch::Tensor, std::vector<torch::Tensor>, std::vector<int64_t>>;
...
class FeatureExtractor {
 public:
  ...
  // TODO: need to cooperate with MMData
  // virtual bool process(const MMInput& mm_inputs, MMData& mm_datas) = 0;
 
  // TODO: A function that should process the audio data, need to be implemented later
